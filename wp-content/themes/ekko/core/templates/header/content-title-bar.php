   ...
   <div class="container">
      ...
      <?php
        if ( tribe_is_month() && !is_tax() ) { // The Main Calendar Page
            echo esc_html__( 'Events Calendar', 'ekko' );
        } elseif ( tribe_is_month() && is_tax() ) { // Calendar Category Pages
            echo esc_html__( 'Events Calendar', 'ekko' ) . ' &raquo; ' . esc_html( single_term_title( '', false ) );
        } elseif ( tribe_is_event() && !tribe_is_day() && !is_single() ) { // The Main Events List
            echo esc_html__( 'Events List', 'ekko' );
        } elseif ( tribe_is_event() && is_single() ) { // Single Events
            echo esc_html( get_the_title() );
        } elseif ( tribe_is_day() ) { // Single Event Days
            echo sprintf( esc_html__( 'Events on: %s', 'ekko' ), date( 'F j, Y', strtotime( $wp_query->query_vars['eventDate'] ) ) );
     ...
     <div class="row blog-page-heading <?php echo esc_attr($title_align_class); ?>">
        ...
        <div class="container">
          ...
          <?php elseif ( is_search() ) : ?>
            <h1 class="section-heading">
               <?php echo apply_filters( 'kd_search_query_title', __("Search results for:", "ekko") ); ?> <?php the_search_query();  ?>
            </h1>
          <?php elseif ( is_category() ) : ?>
            <h1 class="section-heading">
               <?php echo apply_filters( 'kd_single_cat_title', __("Currently browsing:", "ekko") ); ?> <?php single_cat_title(); ?>
            </h1>
          <?php elseif ( is_tag() ) : ?>
            <h1 class="section-heading">
               <?php echo apply_filters( 'kd_single_tag_title', __("All posts tagged:", "ekko") ); ?> <?php single_tag_title(); ?>
            </h1>
          <?php elseif ( is_author() ) : ?>
            <h1 class="section-heading">
               <?php echo apply_filters( 'kd_author_archive_title', __("All posts by", "ekko") ); ?> <?php echo esc_html(get_userdata(get_query_var('author'))->display_name); ?>
            </h1>
          <?php elseif ( is_day() ) : ?>
            <h1 class="section-heading">
               <?php echo apply_filters( 'kd_day_archive_title', __("Posts archive for", "ekko") ); ?> <?php echo get_the_date('F jS, Y'); ?>
            </h1>
          <?php elseif ( is_month() ) : ?>
            <h1 class="section-heading">
               <?php echo apply_filters( 'kd_month_archive_title', __("Posts archive for", "ekko") ); ?> <?php echo get_the_date('F, Y'); ?>
            </h1>
          <?php elseif ( is_year() ) : ?>
            <h1 class="section-heading">
              <?php echo apply_filters( 'kd_year_archive_title', __("Posts archive for", "ekko") ); ?> <?php echo get_the_date('Y'); ?>
            </h1>
