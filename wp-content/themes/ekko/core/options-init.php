<?php
  ...
  */
  ...
  $args = array(
    'opt_name' => $opt_name,
    'display_name' => 'Ekko',
    'display_version' => EKKO_THEME_VERSION,
    'menu_type' => 'submenu',
    'allow_sub_menu' => true,
      ...
      'fields' => array(
          ...
          array(
            ...
            array(
                ...
                'subtitle' => esc_html__( 'Click an icon to activate it, drag and drop to change the icon order.', 'ekko' ),
                'icons' => array(
                    array(
                        'id' => 'airbnb',
                        'icon' => 'fab fa-airbnb',
  ...
  Redux::set_section( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'tek-menu-transparency-hover',
            'type' => 'switch',
            'title' => esc_html__('Menu Opacity Effect', 'ekko'),
            'subtitle' => esc_html__('Enable/Disable the the opacity effect when hovering the main menu.', 'ekko'),
            'default' => true
        ),
        array(
  ...
  Redux::set_section( $opt_name, array(
      ...
      'fields' => array(
          ...
          array(
              ...
              'type' => 'text',
              'title' => esc_html__('Extra CSS Class', 'ekko'),
  ...
  Redux::set_section( $opt_name, array(
      ...
      'fields' => array(
          ...
          array(
              'id' => 'tek-footer-socials',
              'type' => 'switch',
              'title' => esc_html__('Footer Social Icons', 'ekko'),
              'subtitle' => esc_html__('Enable/Disable the footer social icons.', 'ekko'),
              'required' => array( 'tek-footer-bar','equals', true ),
              'default' => true,
          ),
          array(
              'id' => 'tek-upper-footer',
      ...
      'icon' => 'iconsmind-Tag',
        ...
        'fields' => array(
          array(
              ...
              'type' => 'switch',
              'title' => esc_html__('Product Title Bar', 'ekko'),
          ...
          array(
            ...
            'subtitle' => esc_html__('Select the background color used for the single product pages title bar section.', 'ekko'),
            'validate' => 'color'
          ),
          array(
