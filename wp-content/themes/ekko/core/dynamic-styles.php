...
.process-icon i,
.kd-progress-icon i,
.footer_widget ul.redux-social-media-list li i:hover,
...
.cd-handle, .timeline-item-wrapper.full-link-card .timeline-full-link:hover,
...
.menu-item-badge {
	<?php if ( ekko_get_option( 'tek-main-color' ) ) : ?>
		background-color: <?php echo esc_attr( ekko_get_option( 'tek-main-color' ).'1f' ); ?>;
	<?php endif; ?>
}
...
<?php if ( ekko_get_option( 'tek-footer-heading-color' ) ) : ?>
	.upper-footer i,
	.upper-footer .widget-title, .upper-footer .modal-menu-item, .footer_widget ul.redux-social-media-list li i {
...
.upper-footer .widget-title, .upper-footer #wp-calendar caption, .footer_widget .menu li a,.lower-footer ul li.cat-item a, .footer-nav-menu .navbar-footer li a, .lower-footer span, .lower-footer a {
	...
	<?php if ( isset( $footer_typo['font-family'] ) && $footer_typo['font-family'] !== '' ): ?>
		<?php $family = keydesign_format_font_family( $footer_typo['font-family'] ); ?>
		<?php if ( $family ) : ?>
...
<?php  if ( ekko_get_option( 'tek-default-typo' ) ) : ?>
	body, .box, .cb-text-area p, body p , .upper-footer .search-form .search-field, .upper-footer select, .footer_widget .wpml-ls-legacy-dropdown a, .footer_widget .wpml-ls-legacy-dropdown-click a {
		...
		<?php if ( isset( $default_typo['font-family'] ) && $default_typo['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $default_typo['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
.container #logo .logo {
	...
	<?php if ( isset( $text_logo_typo['font-family'] ) && $text_logo_typo['font-family'] !== '' ): ?>
		<?php $family = keydesign_format_font_family( $text_logo_typo['font-family'] ); ?>
		<?php if ( $family ) : ?>
			font-family: <?php echo $family; ?>;
		<?php endif; ?>
	<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-h1-heading' ) ) : ?>
	.container h1 {
		...
		<?php if ( isset( $h1_heading['font-family'] ) && $h1_heading['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $h1_heading['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-h2-heading' ) ) : ?>
	.container h2, #popup-modal .modal-content h2, h2.blog-single-title a  {
		...
		<?php if ( isset( $h2_heading['font-family'] ) && $h2_heading['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $h2_heading['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-h3-heading' ) ) : ?>
	.container h3 {
		...
		<?php if ( isset( $h3_heading['font-family'] ) && $h3_heading['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $h3_heading['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-h4-heading' ) ) : ?>
	...
	.container h4, .kd-photobox .phb-content h4 {
		...
		<?php if ( isset( $h4_heading['font-family'] ) && $h4_heading['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $h4_heading['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-h5-heading' ) ) : ?>
	...
	.container h5 {
		...
		<?php if ( isset( $h5_heading['font-family'] ) && $h5_heading['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $h5_heading['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-h6-heading' ) ) : ?>
	.container h6, .key-icon-box h6.service-heading {
		...
		<?php if ( isset( $h6_heading['font-family'] ) && $h6_heading['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $h6_heading['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-menu-typo' ) ) : ?>
	body .navbar-default .nav li a, body .modal-menu-item {
		...
		<?php if ( isset( $menu_typo['font-family'] ) && $menu_typo['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $menu_typo['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php if ( ekko_get_option( 'tek-typekit-switch' ) && ekko_get_option( 'tek-typekit' ) != '' ) : ?>
...
<?php if ( ekko_get_option( 'tek-button-typo') ) : ?>
	...
	.pricing-table .tt_button, .pricing-table.active .tt_button, .woocommerce .widget_shopping_cart .button, .woocommerce .widget_shopping_cart .button:hover {
		...
		<?php if ( isset( $button_typo['font-family'] ) && $button_typo['font-family'] !== '' ): ?>
			<?php $family = keydesign_format_font_family( $button_typo['font-family'] ); ?>
			<?php if ( $family ) : ?>
				font-family: <?php echo $family; ?>;
			<?php endif; ?>
		<?php endif; ?>
...
<?php if ( class_exists( 'WooCommerce' ) ) : ?>
	<?php if ( ekko_get_option( 'tek-woo-single-titlebar-color' ) ) : ?>
		.single-product.woocommerce-page .blog-header.entry-header {
			background-color: <?php echo esc_attr( ekko_get_option( 'tek-woo-single-titlebar-color' ) ) ?>;
		}
	<?php endif; ?>
<?php endif; ?>
