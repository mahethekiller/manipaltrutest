...
<?php
$term_icon     = $term && ! is_wp_error( $term ) ? get_term_meta( $term->term_id, '_ptbs_term_icon', true ) : 'fas fa-vial';
...
<div style="display:grid; grid-template-columns: 1fr 1fr; gap:16px; margin-bottom:20px;">
    <div>
        ...
        <input type="text" name="term_icon" value="<?php echo esc_attr( $term_icon ); ?>" placeholder="e.g. fas fa-vial" style="width:100%; padding:10px; border:1px solid #cbd5e1; border-radius:6px;">
    </div>
    <div>
...
<div style="margin-bottom:20px;">
    <label style="display:block; font-weight:600; margin-bottom:8px; color:#334155;"><?php esc_html_e( 'Upload Image for Sub Category', 'pathology-booking-system' ); ?></label>
