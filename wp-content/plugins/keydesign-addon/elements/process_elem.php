...
if (!class_exists('tek_process')) {
    class tek_process extends KEYDESIGN_ADDON_CLASS
    {
        ...
        public function kd_process_single($atts, $content = null) {
            ...
            $content_icon = $ps_img_array = $icon_color_style = $icon_size_style = $link_title = $link_target = $pss_icon = $pss_custom_style = $animation_delay = '';
            ...
            if ( $pss_icon_type == 'icon_browser' && !empty( $pss_icon ) ) {
  			...
  			} elseif ( $pss_icon_type == 'custom_image' ) {
                if ( '' != $pss_image && wp_attachment_is_image( $pss_image ) ) {
